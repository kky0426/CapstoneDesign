...
public class BoardAdapter extends RecyclerView.Adapter<BoardViewHolder>  {
    ...
    public BoardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        LayoutInflater inplater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inplater.inflate(R.layout.board_detail,parent,false);
